...
def add_patient(patients, next_id):
    ...
    patient = Patient(next_id, name, age, gender, disease, doctor)
...
def update_patient(patients):
    """Update patient information (CLI mode)"""
    if not patients:
        print("No patient records found.\n")
        return
...
def delete_patient(patients):
    """Delete a patient record (CLI mode)"""
    if not patients:
        print("No patient records found.\n")
        return
